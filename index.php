...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $fechaSalida = !empty($_POST['valorFechaSalida']) ? $_POST['valorFechaSalida'] : NULL;  
    $cantidadSalida = !empty($_POST['valorCantidadSalida']) ? $_POST['valorCantidadSalida'] : 0;  
...
<head>
    ...
    <style>
        ...
        select {
            ...
            -moz-appearance: none;
            appearance: none;
            background: url('https://img.icons8.com/ios-filled/50/000000/chevron-down.png') no-repeat right 10px center; 
